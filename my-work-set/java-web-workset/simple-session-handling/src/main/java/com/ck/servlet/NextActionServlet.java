...
public class NextActionServlet extends HttpServlet {

	private static final String CURRENT_USER = "USER";
	private static final String fromClass = NextActionServlet.class.getSimpleName();
	...
	private void doProcess(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
		 ...
		 * 
		 * // set the cookie Cookie cookie = new Cookie(CURRENT_USER,
		 * formTextBoxName); cookie.setMaxAge(60 * 3); resp.addCookie(cookie);
		 */
